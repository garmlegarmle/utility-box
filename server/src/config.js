...
export function getConfig() {
  ...
  return {
    ...
    githubClientId: String(process.env.GITHUB_CLIENT_ID || '').trim(),
    githubClientSecret: String(process.env.GITHUB_CLIENT_SECRET || '').trim(),
    githubOauthScope: String(process.env.GITHUB_OAUTH_SCOPE || 'read:user').trim(),
